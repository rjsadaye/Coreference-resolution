...
parser.add_argument("-s3", "--string3", required=True, dest="string3",help="enter type of search")
...
name_l1,count=concept_lookup(apikey,version,string1)
name_l2,count=concept_lookup(apikey,version,string2)    
#print(len(name_l1))

with open('name_l1.pickle','wb') as p:
  pickle.dump(name_l1,p,protocol=2)
with open('name_l2.pickle','wb') as p:
